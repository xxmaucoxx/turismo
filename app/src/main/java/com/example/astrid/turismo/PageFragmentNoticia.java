...
public class PageFragmentNoticia extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista = inflater.inflate(R.layout.fragment_page_fragment_noticia, container, false);

        keyStore = getArguments().getString("textFromActivityB");

        rv = (RecyclerView) vista.findViewById(R.id.recyclerViewNoticia);
        ...
        Query postRef = ref.child("usuarios/"+keyStore+"/post").limitToFirst(5);
    ...
    private void obtenerDatos() {
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference();
        Query postRef = ref.child("usuarios/"+keyStore+"/post").orderByKey().endAt(lastkey).limitToLast(5);
